...
public class CalendarExample {
	...
	public static void main(String[] args) {
        ...
        int a14 = now.get(12); //상수값
        System.out.println(a13 + " " + a14);
        
        int a15 = now.get(Calendar.SECOND); //상수명
        int a16 = now.get(13); //상수값
        System.out.println(a15 + " " + a16);
        
        // 2023년 12월 20일 11시 53분
        System.out.println(now.get(Calendar.YEAR) + "년" + now.get(Calendar.MONTH) + "월" + now.get(Calendar.DAY_OF_MONTH) + "일" + now.get(Calendar.HOUR)+ "시" + now.get(Calendar.MINUTE)+ "분");
